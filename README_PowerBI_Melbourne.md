...
🔗 **Live Dashboard:**  
[INSERT POWER BI PUBLISH LINK HERE]
...
### dim_suburb (melb_suburb_summary.csv)
...
| avg_building_area | Mean building area |
| total_revenue | Sum of all sale prices |
| transaction_count | Number of sales |
| revenue_pct | Suburb share of total revenue (%) |
| cumulative_revenue_pct | Cumulative revenue % (sorted descending) |
| price_to_area_ratio | Avg price ÷ avg building area |
